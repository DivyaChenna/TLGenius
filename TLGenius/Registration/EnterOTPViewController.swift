...
class EnterOTPViewController: UIViewController,UITextFieldDelegate,UIScrollViewDelegate{
    ...
    @IBOutlet weak var wrongNumBtn: UIButton!
    ...
    @IBAction func nextBtnClicked(sender: UIButton!) {
        ...
        self.performSegue(withIdentifier:"GoToSetPwdScreen", sender: self)
    }
    ...
    @IBAction func wrongNumBtnClicked(sender: UIButton!) {
        self.navigationController?.popViewController(animated: true)
    }
