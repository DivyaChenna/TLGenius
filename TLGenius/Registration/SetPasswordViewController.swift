...
class SetPasswordViewController: UIViewController,UITextFieldDelegate,UIScrollViewDelegate {
...
//                        }
        ...
        self.performSegue(withIdentifier:"GoToRegistrationScreen", sender: self)
