...
class BandViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    @IBOutlet weak var addBandBtn : UIButton!

    @IBOutlet weak var addBandVw : UIView!
    @IBOutlet weak var bandListVw : UIView!
    ...
    override func viewDidLoad() {
        ...
        addBandBtn.layer.cornerRadius = 17.0
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if tableView == addListTblVw {
            self.performSegue(withIdentifier: "GoToSelectBandScreen", sender: self)
        }
    }
    ...
    @IBAction func addBandBtnClicked(sender: UIButton!) {
        self.performSegue(withIdentifier: "GoToSelectBandScreen", sender: self)
    }
